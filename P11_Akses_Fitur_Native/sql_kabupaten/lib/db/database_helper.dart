...
class DatabaseHelper {
  ...
  /// **Fungsi untuk menghapus kabupaten berdasarkan ID**
  Future<int> deleteKabupaten(int id) async {
    final db = await database;
    return await db.delete('kabupaten', where: 'id = ?', whereArgs: [id]);
  }

  /// **Fungsi untuk memperbarui data kabupaten**
  Future<int> updateKabupaten(Kabupaten kab) async {
    final db = await database;
